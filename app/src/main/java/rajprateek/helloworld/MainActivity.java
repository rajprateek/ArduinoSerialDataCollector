...
public class MainActivity extends AppCompatActivity {
    ...
    private void startMicRecording() {
        ...
        try {
            ...
            Toast toast = Toast.makeText(getApplicationContext(), "Problem reading mic data. Check permissions", Toast.LENGTH_LONG);
            toast.show();
...
//                    out += new String(buffer, 0, read);
                    ...
                    String string = System.currentTimeMillis() + ", " + data;
            ...
            Toast toast = Toast.makeText(getApplicationContext(), "Problem reading sensor values, check permissions and connection.", Toast.LENGTH_LONG);
            toast.show();
